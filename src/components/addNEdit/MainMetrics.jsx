...
export const MainMetrics = ({
  ...
  return (
    <div className="main-metrics-container">
      <div className="main-metrics-block-text " onClick={changeStateHandler}>
      ...
      <div id={show} className={`main-metrics-fields-container`}>
        ...
        <div className="main-metrics-field-2">
          ...
          <div id={show} className="input-field-months">
            <input
              className="main-metrics-input"
              type="text"
              name="period_from"
          ...
          <div id={show} className="input-field-small">
            <div className="small-div-for-double-input">
              <div className="relative">
                <input
                  className="main-metrics-input-small"
        ...
        <div id={show} className="main-metrics-field-2">
        ...
        <div id={show} className="button-submit-save">
          <Button
            type="submit"
